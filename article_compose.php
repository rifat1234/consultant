  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
		...
		<div class="jumbotron">
		<h1><center>Post Article</center></h1>
			<div class=" container-fluid">
			<h2>Article Title</h2>
			 <form class="form-horizontal" role="form" action="article_post.php" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-14">
			<textarea class="form-control" rows="18" id="article" name="article" required type="text" ></textarea>
            </div></div>
